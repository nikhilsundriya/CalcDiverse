...
```css
git remote add upstream https://github.com/nikhilsundriya/CalcDiverse.git
```
...
<h3>💫 Alternatively, contribute using GitHub Desktop</h3>

1. **Open GitHub Desktop:**
   Launch GitHub Desktop and log in to your GitHub account if you haven't already.

2. **Clone the Repository:**
   - If you haven't cloned the CalcDiverse repository yet, you can do so by clicking on the "File" menu and selecting "Clone Repository."
   - Choose the CalcDiverse repository from the list of repositories on GitHub and clone it to your local machine.
...
7. **Create a Pull Request:**
  - Go to the GitHub website and navigate to your fork of the CalcDiverse repository.
...
9. **Wait for Review:**
    Your pull request will now be available for review by the project maintainers. They may provide feedback or ask for changes before merging your pull request into the main branch of the CalcDiverse repository.
...
1. Please follow our project's [Code of Conduct](https://github.com/nikhilsundriya/CalcDiverse/blob/main/.github/CODE_OF_CONDUCT.md) while contributing.
2. Treat all contributors and users with respect and create a positive and inclusive environment for everyone.</p>

<h2>⚡ License</h2>

1. The project is licensed under [Apache-2.0 license](https://github.com/nikhilsundriya/CalcDiverse/blob/main/LICENSE). Make sure to review and comply with the license terms.
